;;; earth-dark-theme.el --- earth-dark
;;; Version: 1.0
;;; Commentary:
;;; A theme called earth-dark
;;; Code:

(deftheme earth-dark "DOCSTRING for earth-dark")
  (custom-theme-set-faces 'earth-dark
...
(provide-theme 'earth-dark)

;;; earth-dark-theme.el ends here
